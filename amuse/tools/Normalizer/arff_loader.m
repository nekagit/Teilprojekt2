function [feat_values,attributes]=arff_loader(feature_file)
...
% Fill in the matrix TODO length(attributes-1) because of WINDOW_NUMBER
% attribute
feat_values=zeros(length(attributes)-1,length(data{1,1}));
